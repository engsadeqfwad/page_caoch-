...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 md:py-32 bg-dark-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="animate-on-scroll delay-1 section-heading mb-4">
            لديكِ استفسار؟{' '}
            <span className="gradient-text">إليكِ كل التفاصيل.</span>
          </h2>
        ...
        <div className="space-y-3.5">
          {faqItems.map((item, index) => (
            <div
              key={item.id}
              className={`animate-on-scroll delay-${Math.min(index + 1, 6)}`}
            >
              <div
                ...
                style={{
                  ...
                  border: openId === item.id
                    ? '1px solid rgba(186,120,92,0.6)'
                    : '1px solid rgba(239,208,213,0.15)',
                  boxShadow: openId === item.id
                    ? '0 8px 30px rgba(90,33,53,0.4)'
              ...
              >
                ...
                >
                  <div className="px-5 md:px-6 pb-5 md:pb-6">
                    <div
                      className="h-px mb-4"
                      style={{ background: 'linear-gradient(90deg, rgba(239,208,213,0.3), transparent)' }}
                    />
        ...
        <div className="animate-on-scroll delay-4 mt-12 text-center">
          <p className="text-sm text-taupe mb-4 font-semibold">لديكِ استفسار خاص لم يذكر؟</p>
          <button
            className="btn-secondary text-sm"
            onClick={() => {
              window.open('mailto:hello@femina-wellness.com', '_blank');
            }}
          >
            تواصلي مباشرة معنا
          </button>
